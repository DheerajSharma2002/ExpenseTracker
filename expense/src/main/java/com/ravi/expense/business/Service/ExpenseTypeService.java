package com.ravi.expense.business.Service;

import com.ravi.expense.Repository.ExpenseTypeRepository;
import com.ravi.expense.business.Exceptions.ExpenseTypeAlreadyExist;
...
public class ExpenseTypeService {
     ...
     * @throws ExpenseTypeAlreadyExist If an ExpenseType already exists in the database.
     */
    public ExpenseType save(ExpenseType entity) throws ExpenseTypeAlreadyExist {
        if (expenseTypeRepository.existsByExpenseCategoryIgnoreCase(entity.getExpenseCategory())){
            throw new ExpenseTypeAlreadyExist("Expense type with name '" + entity.getExpenseCategory() + "' already exists.");
        }
